...
public class ChessMatch {
  ...
  /**
   * Constructs a new ChessMatch with an 8x8 chessboard, sets the initial turn to 1, and initializes
   * the current player to White. Also, sets up the initial chessboard position.
   */
  ...
  /**
   * Replaces the promoted pawn with a new chess piece of the specified type (Bishop, Knight, Queen,
   * Rook).
   *
